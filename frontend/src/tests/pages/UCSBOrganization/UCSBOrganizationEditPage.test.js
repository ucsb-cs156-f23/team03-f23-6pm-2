...
describe("UCSBOrganizationEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            fireEvent.change(orgCodeField, { target: { value: 'ZPP' } });
            fireEvent.change(orgTranslationShortField, { target: { value: "ZETA PHI PHI" } });
            fireEvent.change(orgTranslationField, { target: { value: "ZETA PHI PHI" } });
            ...
            expect(axiosMock.history.put[0].params).toEqual({ orgCode : "ZPP" });
