...
export default function UCSBDiningCommonsMenuItemEditPage({storybook=false}) {
    ...
    const onSuccess = (ucsbDiningCommonsMenuItem) => {
        toast(`UCSBDiningCommonsMenuItem Updated - id: ${ucsbDiningCommonsMenuItem.id} diningCommonsCode: ${ucsbDiningCommonsMenuItem.diningCommonsCode} name: ${ucsbDiningCommonsMenuItem.name} station: ${ucsbDiningCommonsMenuItem.station}`);
    }
